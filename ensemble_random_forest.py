...
"""
# exercise : sum() and elements in array
X_new = np.array([[0.8]])
X_new
...
plt.title("learning_rate={}, n_estimator={}".format(gbrt.learning_rate, gbrt.n_estimators), fontsize=14)
...
#-----------------------------------------------------------------------
# Gradient Boosting with early stopping using when the error become min
#-----------------------------------------------------------------------
import numpy as np
from sklearn.model_selection import train_test_split
...
print(gbrt.n_estimators) #in this case, number of estimator, i.e. number of decision tree is 61 
